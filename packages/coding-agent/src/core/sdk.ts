...
const readTool = allTools.read;
const bashTool = allTools.bash;
const editTool = allTools.edit;
const writeTool = allTools.write;
const grepTool = allTools.grep;
const findTool = allTools.find;
const lsTool = allTools.ls;
