...
/**
 * Combined autocomplete provider that handles slash commands, @-file
 * references (via `fd` fuzzy search), and bare path completions.
 *
 * Path parsing and value construction are delegated to the pure helpers
 * in `autocomplete-path.ts`.
 */
